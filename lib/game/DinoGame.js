...
export default class DinoGame extends GameRunner {
  ...
  endGame() {
    ...
    this.paintText(
      'Subí una captura de esta pantalla\netiquetando a @lifecinemas y @dimanacho\ny participás para ver Mario en el cine',
      this.width / 2,
      this.height / 3 - 10,
      {
        font: 'PressStart2P',
  ...
  drawScore() {
    ...
    if (shouldDraw) {
      ...
      this.paintText((drawValue + '').padStart(5, '0'), this.width - 5, 5, {
        font: 'PressStart2P',
        size: `${fontSize}px`,
        align: 'right',
        baseline: 'top',
